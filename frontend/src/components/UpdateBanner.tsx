        ...
        <AnimatePresence>
            {available && (
                <motion.div
                    ...
                    exit={{ opacity: 0, y: -50 }}
                    className="relative w-full z-40 p-3 bg-gradient-to-r from-primary/90 via-link-blue/90 to-brand-purple/90 backdrop-blur-sm shadow-lg border-b border-white/10"
                >
