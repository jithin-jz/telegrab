                ...
                >
                    ...
                    >
                        ...
                        <div className="px-5 py-4 border-b border-hairline flex justify-between items-start gap-4 bg-surface/80">
                            ...
                            <button
                                onClick={onClose}
                                className="w-8 h-8 grid place-items-center hover:bg-surface-soft rounded-md text-slate hover:text-foreground transition"
                        ...
                        <div className="flex-1 px-5 py-5 space-y-5 overflow-y-auto custom-scrollbar">
                            ...
                            <section className="space-y-3">
                                <h3 className="text-xs font-semibold text-slate uppercase tracking-wider flex items-center gap-2">
                                ...
                                <Card className="bg-surface">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <p className="text-sm text-foreground font-medium">Concurrent Uploads</p>
                                            <p className="text-xs text-slate">Max parallel uploads</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <Button
                                            ...
                                            className="h-7 w-7 text-sm text-slate hover:text-foreground"
                                        >
                                            -
                                        </Button>
                                        <span className="text-sm text-foreground font-medium w-5 text-center">
                                ...
                                <Card className="bg-surface">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <p className="text-sm text-foreground font-medium">Concurrent Downloads</p>
                                            <p className="text-xs text-slate">Max parallel downloads</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <Button
                            ...
                            <section className="space-y-3">
                                ...
                                <Card className="bg-surface">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <p className="text-sm text-foreground font-medium">Enable API Server</p>
                                    ...
                                    <button
                                        ...
                                        disabled={apiLoading}
                                        className={`relative w-11 h-6 rounded-full transition-colors duration-200 ${apiSettings.enabled ? 'bg-primary' : 'bg-hairline'} disabled:opacity-50 shrink-0`}
                                ...
                                <Card className="bg-surface">
                                    <CardContent className="flex items-center justify-between gap-4 p-3">
                                    <div>
                                        <p className="text-sm text-foreground font-medium">Port</p>
                                        <p className="text-xs text-slate">1024 - 65535</p>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <Input
                                            type="number"
                                ...
                                <Card className="bg-surface">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                <p className="text-sm text-foreground font-medium">API Key</p>
                                                <p className="text-xs text-slate">
                                    ...
                                    {generatedKey && (
                                        <div className="mt-2 p-2.5 bg-canvas rounded-lg border border-yellow-500/20">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <code className="flex-1 text-xs text-foreground font-mono bg-surface-soft rounded px-2 py-1.5 overflow-x-auto select-all">
                                                    {generatedKey}
                                                </code>
                                                <button
                                                    onClick={handleCopyKey}
                                                    className="p-1.5 rounded-md hover:bg-surface-soft text-slate hover:text-foreground transition flex-shrink-0"
                            ...
                            <section className="space-y-3">
                                ...
                                <Card className="bg-surface">
                                    <CardContent className="flex items-center justify-between gap-4 p-3">
                                    <div className="flex items-center gap-2">
                                        <Trash2 className="w-4 h-4 text-slate" />
                                        <div>
                                            <p className="text-sm text-foreground font-medium">Clear Local Cache</p>
                                            <p className="text-xs text-slate">Remove cached previews and temp files</p>
                                        </div>
                                    </div>
                                    <Button
                                        type="button"
                        ...
                        <div className="px-5 py-3 border-t border-hairline bg-surface/80 flex items-center justify-between gap-3">
                            <Button
                                ...
                                className="h-8 text-xs text-slate hover:text-rose-400 hover:bg-rose-500/10"
                            >
